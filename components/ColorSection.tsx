...
const PALETTES = {
  ...
  special: [
    ...
    { name: 'Link Water', nameZh: '链接水', hex: '#eff5fa', rgb: '239, 245, 250', cmyk: '4, 2, 0, 2', textDark: true },
    ...
    <div className="space-y-16 animate-fadeIn pb-24">
      ...
      <section>
        ...
        <div className="mb-6">
           ...
           <p className="text-gray-500 mt-1">{t.titles.primaryDesc}</p>
        </div>
        ...
        <div className="mb-6">
           ...
           <p className="text-gray-500 mt-1 max-w-3xl">{t.titles.secondaryDesc}</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
      ...
      <section>
        <div className="mb-6">
           ...
           <p className="text-gray-500 mt-1">{t.titles.neutralDesc}</p>
        </div>
      ...
      <div className="space-y-12">
         <section>
            ...
            <p className="text-gray-500 text-sm mb-6">{t.titles.hktwDesc}</p>
         ...
         <section>
            ...
            <p className="text-gray-500 text-sm mb-6">{t.titles.specialDesc}</p>
      ...
      <section className="pt-8 border-t border-gray-100">
          ...
          <p className="text-gray-600 mb-8 max-w-3xl whitespace-pre-line">{t.titles.proportionsDesc}</p>
          <DownloadableImage 
