  ...
  return (
    <div className="space-y-24 animate-fadeIn pb-24">
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">{t.norms.desc}</p>
        <ul className="list-disc list-outside ml-5 text-gray-600 mb-8 space-y-2">
        ...
        <div className="flex flex-col gap-4">
            <DownloadableImage 
                ...
                alt="Symbol Norms" 
            />
            <p className="text-sm text-gray-700 font-medium">{t.norms.caption}</p>
        </div>
      </section>
      ...
      <section>
        ...
        {/* Scenario 1 */}
        <div className="mb-12">
            <p className="text-gray-600 mb-4 font-medium">{t.usage.scenario}</p>
            <ul className="list-disc list-outside ml-5 text-gray-600 mb-8 space-y-2">
                {t.usage.list.map((item, idx) => (
                    <li key={idx}>{item}</li>
                ))}
            </ul>
            {/* Changed from grid to vertical stack, moving captions outside to match LogoSection style */}
        ...
        {/* Mobile Icons */}
        <div>
            <p className="text-gray-600 mb-6 max-w-3xl whitespace-pre-line">{t.usage.mobileDesc}</p>
            <DownloadableImage 
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">{t.minSize.desc}</p>
        <p className="text-gray-600 mb-8">{t.minSize.detail}</p>
        <DownloadableImage 
