  ...
  return (
    <div className="space-y-24 animate-fadeIn pb-24">
      ...
      <section>
          ...
          <p className="text-gray-600 mb-8 max-w-3xl">{t.symbolism.desc}</p>
      ...
      <section>
          ...
          <p className="text-gray-600 mb-8">{t.usage.desc}</p>
      ...
      <div className="space-y-24">
         <section>
            ...
            <p className="text-gray-600 mb-6 text-sm max-w-3xl">{t.clearspace.desc}</p>
            <ul className="list-disc list-outside ml-5 text-gray-600 mb-8 space-y-2 text-sm max-w-3xl">
         ...
         <section>
            ...
            <p className="text-gray-600 mb-8 text-sm max-w-3xl">{t.minSize.desc}</p>
      ...
      <section>
          ...
          <p className="text-gray-600 mb-8 max-w-3xl">{t.colors.desc}</p>
      ...
      <section>
          ...
          <p className="text-gray-600 mb-8 max-w-3xl">{t.priority.desc}</p>
      ...
      <section>
          ...
          <p className="text-gray-600 mb-8 max-w-3xl">{t.backgrounds.desc}</p>
      ...
      <div className="space-y-24">
          <section>
              ...
              <p className="text-gray-600 mb-6 text-sm max-w-3xl">{t.placement.desc}</p>
          ...
          <section>
              ...
              <p className="text-gray-600 mb-6 text-sm max-w-3xl">{t.symbolPlacement.desc}</p>
      ...
      <div className="space-y-24">
          <section>
             ...
             <p className="text-gray-600 mb-6 text-sm max-w-3xl">{t.watermark.desc}</p>
          ...
          <section>
             ...
             {t.lockups.desc && <p className="text-gray-600 mb-6 text-sm max-w-3xl">{t.lockups.desc}</p>}
      ...
      <section>
          ...
          <p className="text-gray-600 mb-6">{t.social.desc}</p>
          <ul className="list-disc list-outside ml-5 text-gray-600 mb-8 space-y-2 text-sm">
          ...
          <div className="space-y-12">
              ...
              <div>
                  <p className="text-gray-600 text-sm mb-6">{t.social.construction}</p>
