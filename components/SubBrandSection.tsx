    ...
    <div className="space-y-24 animate-fadeIn pb-24">
      ...
      <section>
          ...
          <div className="space-y-8">
             ...
             <div className="space-y-4 max-w-4xl text-gray-600">
      ...
      <section className="space-y-20">
          {t.brands.map((brand, index) => (
              <div key={index} className="scroll-mt-24">
                  ...
                  <p className="text-gray-600 mb-8 max-w-4xl">{brand.desc}</p>
      ...
      <section className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
         ...
         <div className="grid md:grid-cols-2 gap-6">
             ...
             />
             <FileDownload 
                href="https://pic4.fukit.cn/autoupload/AOPlz_F9vA1htssbUdr8a8kJiVcdDX0rG09M-a0gARI/20251211/PBpv/Proxima_Nova_%281%29.zip" 
                label="Proxima Nova" 
                format="ZIP" 
             />
         </div>
