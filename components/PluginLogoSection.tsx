    ...
    <div className="space-y-24 animate-fadeIn pb-24">
      ...
      <section className="space-y-8">
        ...
        <div className="max-w-3xl py-4">
          <p className="text-gray-600 leading-relaxed whitespace-pre-line text-lg">{t.specs.usageNote}</p>
        </div>
      </section>
      ...
      <section className="space-y-12">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 text-lg max-w-4xl">{t.collection.updateDesc}</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-gray-500 font-medium text-center mt-4">{t.collection.caption}</p>
        </div>
      </section>
    </div>
  );
