  ...
  return (
    <div className="space-y-24 animate-fadeIn pb-24">
      ...
      <section>
        ...
        <div className="space-y-12">
            <div className="space-y-6">
                <p className="text-gray-600 max-w-4xl">{t.fonts.descEn}</p>
            ...
            <div className="space-y-6">
                <p className="text-gray-600 max-w-4xl">{t.fonts.descCn}</p>
                <div className="flex flex-col gap-2">
                    <DownloadableImage 
      ...
      <section>
         ...
         <p className="text-gray-600 mb-12 max-w-4xl">{t.hierarchy.desc}</p>
      ...
      <section>
         ...
         <p className="text-gray-600 mb-12 max-w-4xl">{t.scale.desc}</p>
      ...
      <section className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
             <FileDownload 
                href="https://pic4.fukit.cn/autoupload/AOPlz_F9vA1htssbUdr8a8kJiVcdDX0rG09M-a0gARI/20251211/geuS/Proxima_Nova.zip" 
                label="Proxima Nova" 
                format="ZIP" 
             />
             <FileDownload 
